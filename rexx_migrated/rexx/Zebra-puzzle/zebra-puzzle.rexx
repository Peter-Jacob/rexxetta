...
*--------------------------------------------------------------------*/
Call mknewV1perm    /*ª* compute all permutations                        */
Call encode     /*ª* encode the elements of the specifications       */
/*ª* ex2 .. eg16     the formalized specifications                   */
solutions=0
Call time 'R'
Do nationnewV1i = 1 TO 120
Nations = perm.nationnewV1i
IF ex10() Then Do
Do colornewV1i = 1 TO 120
Colors = perm.colornewV1i
IF ex5() & ex2() & ex15() Then Do
Do drinknewV1i = 1 TO 120
Drinks = perm.drinknewV1i
IF ex9() & ex4() & ex6() Then Do
Do smokenewV1i = 1 TO 120
Smokes = perm.smokenewV1i
IF ex14() & ex13() & ex16() & ex8() Then Do
Do animalnewV1i = 1 TO 120
Animals = perm.animalnewV1i
IF ex3() & ex7() & ex11() & ex12() Then Do
/*ª* Call out 'Drinks =' Drinks  54321 Wat Tea Mil Cof Bee */
/*ª* Call out 'Nations=' Nations 41235 Nor Den Eng Ger Swe */
/*ª* Call out 'Colors =' Colors  51324 Yel Blu Red Gre Whi */
/*ª* Call out 'Smokes =' Smokes  31452 Dun Ble Pal Pri Blu */
/*ª* Call out 'Animals=' Animals 24153 Cat Hor Bir Zeb Dog */
...
mknewV1perm: Procedure Expose perm.
/*ª*---------------------------------------------------------------------
...
Return
/* -------------------------------------------------------------------------
 * REXX C:\Users\PeterJ\rexxetta\rexx\Zebra-puzzle\zebra-puzzle.rexx was migrated on 23 Mar 2025 at 10:43:36
 * -------------------------------------------------------------------------
*/ 

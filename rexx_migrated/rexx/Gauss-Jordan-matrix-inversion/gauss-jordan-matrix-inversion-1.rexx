...
denom: Procedure
/*ª* Return the denominator */
Parse Arg d '/' n
Return d

decimal: Procedure
/*ª* compute the fraction's value */
Parse Arg a
...
Exit: Say arg(1)
/* -------------------------------------------------------------------------
 * REXX C:\Users\PeterJ\rexxetta\rexx\Gauss-Jordan-matrix-inversion\gauss-jordan-matrix-inversion-1.rexx was migrated on 23 Mar 2025 at 10:43:15
 * -------------------------------------------------------------------------
*/ 

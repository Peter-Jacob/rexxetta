...
if hi=='' | hi==","  then hi= lo                 /*�* "      "         "   "   "     "    */
newV1.= 0;    newV1.0= 1; newV1.1= 1; newV1.2= 2; newV1.3= 3; newV1.4= 5 /*�*assign default value and low values. */
newV2.= newV1.;   newV2.1= 1; newV2.3= 1; newV2.5= 1; newV2.7= 1; newV2.9= 1 /*�*assign default value and even digits.*/
...
/*�*──────────────────────────────────────────────────────────────────────────────────────*/
partP:  procedure expose newV1. newV2.;  parse arg n     /*�*obtain number (index) for computation*/
...
if k//2    then newV4= newV4 +  x + y               /*�*Odd? Then   sum    X and Y.*/

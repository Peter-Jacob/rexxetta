/*ª*REXX program plays  guessâ”€theâ”€number  (with itself)  with  positive integers.         */
parse arg low high seed .                        /*ª*obtain optional arguments from the CL*/
...
newV1= random(low, high)                             /*ª*generate random number from low->high*/

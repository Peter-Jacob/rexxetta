...
circles= words(data) % 3     /*™*     ‚ïê‚ïêx‚ïê‚ïê          ‚ïê‚ïêy‚ïê‚ïê       ‚ïê‚ïêradius‚ïê‚ïê     */
parse var data minX minY . 1 maxX maxY .              /*™*assign minimum & maximum values.*/
do j=1  for circles;      newV5= j * 3  -  2  /*™*assign some circles with datum. */
...
dx= (maxX-minX) / box
dy= (maxY-minY) / box
newV6= 0                                                  /*™*count of sample points (so far).*/

...
End
Else                           /*ª* life cell                  */
b.x.y=' '                    /*ª*  remains dead              */

End
Else Do                          /*ª* life cell                  */
If neighbors=2 |,
neighbors=3 Then b.x.y='*'  /*ª*  remains life              */
Else b.x.y=' '  /*ª*  dies                      */
End
End
End
/*ª* b. is the new state and is now copied to a.                     */
Do y=yma To ymi By -1
Do x=xmi To xma
a.x.y=b.x.y
End
End
End
/*ª* Output name and all states                                        */
Call lineout oid,' 'f
st=' +'                                /*ª* top and bottom border      */
sb=' +'                                /*ª* top and bottom border      */
Do s=1 To step
st=st||'-'right(s,2,'-')||copies('-',xmax-xmin)'+'
sb=sb||copies('-',xmax-xmin+3)'+'
End
Call lineout oid,st                    /*ª* top border                 */
Do y=ymin To ymax
ol=''
Do s=1 To step
...
Call lineout oid,ol '|'
End
Call lineout oid,sb                    /*ª* bottom border              */
Call lineout oid
'type' oid
If debug Then Do
...
store:
/*ª* store current state (a.) in lines m.step.*                        */
Do y=yy To 1 By -1
ol=''
Do x=1 To ml
z=a.x.y
...
is_equal:
/*ª* test ist state a.b is equal to state a.a                          */
Parse Arg a,b
Do y=yy To 1 By -1
If x.b.y<>x.a.y Then
Return 0
...
Return
/* -------------------------------------------------------------------------
 * REXX C:\Users\PeterJ\rexxetta\rexx\Conways-Game-of-Life\conways-game-of-life-2.rexx was migrated on 23 Mar 2025 at 10:43:09
 * -------------------------------------------------------------------------
*/ 

...
/*ª* sl and tl are the number of characters in string s and t respectively */
Parse Arg s,sl,t,tl
If ld.sl.tl<>'' Then
Return ld.sl.tl
Select
...
Otherwise Do
/*ª* test if last characters of the strings match */
cost=substr(s,sl,1)<>substr(t,tl,1)
/*ª* return minimum of delete char from s, delete char from t,
...
Return ld.sl.tl
/* -------------------------------------------------------------------------
 * REXX C:\Users\PeterJ\rexxetta\rexx\Levenshtein-distance\levenshtein-distance-4.rexx was migrated on 23 Mar 2025 at 10:43:19
 * -------------------------------------------------------------------------
*/ 

...
cnt.=0
i=0
/*ª* first take all possible pairs 2<=x<y with x+y<=100 */
/*ª* and compute the respective sums and products       */
/*ª* count the number of times a sum or product occurs  */
Do x=2 To 98
Do y=x+1 To 100-x
x=right(x,2,0)
y=right(y,2,0)
...
End
n=i
/*ª* now compute the possible pairs for each sum sum_d.sum */
/*ª*                                 and product prd_d.prd */
/*ª* also the list of possible sums and products suml, prdl*/
sum_d.=''
prd_d.=''
suml=''
prdl=''
...
Return strip(swl)
/* -------------------------------------------------------------------------
 * REXX C:\Users\PeterJ\rexxetta\rexx\Sum-and-product-puzzle\sum-and-product-puzzle-1.rexx was migrated on 23 Mar 2025 at 10:43:31
 * -------------------------------------------------------------------------
*/ 

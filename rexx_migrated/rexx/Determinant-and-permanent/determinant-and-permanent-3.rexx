...
**********************************************************************/
Call init arg(1)                 /*ª* initialize the matrix (n and a.* */
sum=0
rowsumprod=0
rowsum=0
chi.=0
c=2**n
Do k=1 To c-1                       /*ª* loop all 2^n submatrices of A */
rowsumprod = 1
chis=dec2binarr(k,n)              /*ª* characteristic vector         */
Do ci=0 By 1 While chis<>''
Parse Var chis chi.ci chis
End
Do m=0 To n-1                     /*ª* loop columns of submatrix #k  */
rowsum = 0
Do p=0 To n-1                   /*ª* loop rows and compute rowsum  */
mnp=m*n+p
rowsum=rowsum+chi.p*A.mnp
End
rowsumprod=rowsumprod*rowsum  /*ª* update product of rowsums     */
/*ª* (optional -- use for sparse matrices) */
/*ª* if (rowsumprod == 0) break;           */
End
...
End
/* -------------------------------------------------------------------------
 * REXX C:\Users\PeterJ\rexxetta\rexx\Determinant-and-permanent\determinant-and-permanent-3.rexx was migrated on 23 Mar 2025 at 10:43:10
 * -------------------------------------------------------------------------
*/ 

/*ª*REXX program uses the Ramer-Douglas-Peucker (RDP) line simplification algorithm  for*/
/*ª*--------------------------- reducing the number of points used to define its shape. */
Parse Arg epsilon pl                           /*ª*obtain optional arguments from the CL*/
...
Return r
/* -------------------------------------------------------------------------
 * REXX C:\Users\PeterJ\rexxetta\rexx\Ramer-Douglas-Peucker-line-simplification\ramer-douglas-peucker-line-simplification-2.rexx was migrated on 23 Mar 2025 at 10:43:26
 * -------------------------------------------------------------------------
*/ 

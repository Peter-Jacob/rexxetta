...
m=word(ml,mi)
jd=greg2jul(j m 1)
IF jd//7=4 Then Do              /*ª* 1st m j is a Friday */
nr5fwe=nr5fwe+1
year_has_5fwe=1
...
Return result                   /*ª* return the result              */

leapyear: Return ( (arg(1)//4=0) & (arg(1)//100<>0) ) | (arg(1)//400=0)
/* -------------------------------------------------------------------------
 * REXX C:\Users\PeterJ\rexxetta\rexx\Five-weekends\five-weekends-3.rexx was migrated on 23 Mar 2025 at 10:43:14
 * -------------------------------------------------------------------------
*/ 

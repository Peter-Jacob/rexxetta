...
parse arg digs sDigs . 1 . . newV1                   /*�*obtain optional arguments from the CL*/
if  digs=='' |  digs==","  then  digs= d         /*�*Not specified?  Then use the default.*/
if sDigs=='' | sDigs==","  then sDigs= d % 2     /*�* "      "         "   "   "      "   */
if     newV1=''  |     newV1=","   then newV1= 19 43 67 163  /*�* "      "         "   "   "      "   */
...
say
do  j=1  for words(newV1);   newV2= word(newV1, j)    /*�*process each of the Heegner numbers. */
say 'When using the Heegner number: '  newV2  /*�*display which Heegner # is being used*/
z= exp(pi * sqrt(newV2) )                     /*�*perform some heavy lifting here.     */
...
z=1;  newV3=1;   w=z;     do j=1; newV3= newV3*x/j;  z=(z+newV3)/1; if z==w  then leave;  w=z;  end
...
/* -------------------------------------------------------------------------
 * REXX C:\Users\PeterJ\rexxetta\rexx\Ramanujans-constant\ramanujans-constant.rexx was migrated on 23 Mar 2025 at 10:43:25
 * -------------------------------------------------------------------------
*/ 

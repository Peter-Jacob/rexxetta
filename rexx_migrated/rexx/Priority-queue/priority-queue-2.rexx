/*ª*REXX pgm implements a priority queue; with insert/show/delete top task*/
n=0
task.=0 /*ª* for the sake of task.0done.* */
...
top: procedure expose n task. todo /*ª* get top task and mark it 'done' */
high=0
Do i=1 To n
If task.0pri.i>high &,
...
return res
/* -------------------------------------------------------------------------
 * REXX C:\Users\PeterJ\rexxetta\rexx\Priority-queue\priority-queue-2.rexx was migrated on 23 Mar 2025 at 10:43:25
 * -------------------------------------------------------------------------
*/ 

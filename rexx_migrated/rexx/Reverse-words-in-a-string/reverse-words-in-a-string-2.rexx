...
do k=words(newV1.j)   to 1   by -1    /*ª*process each word in a   @.j  string.*/
newV2=newV2  word(newV1.j,k)                  /*ª*append a word to the new line  ($).  */
end   /*ª*k*/                       /*ª* [â†‘]  process last word to first word*/

say newV2                                /*ª*display the newly constructed line.  */
end      /*ª*j*/                       /*ª*stick a fork in it,  we're all done. */
/* -------------------------------------------------------------------------
 * REXX C:\Users\PeterJ\rexxetta\rexx\Reverse-words-in-a-string\reverse-words-in-a-string-2.rexx was migrated on 23 Mar 2025 at 10:43:27
 * -------------------------------------------------------------------------
*/ 

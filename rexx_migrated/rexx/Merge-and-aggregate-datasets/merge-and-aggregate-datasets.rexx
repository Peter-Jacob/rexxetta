...
idl=idl id
End
n=n-1 /*ª* number of patients */
visits='visits.csv'
l=linein(visits) /*ª* skip the header line of this file */
h3='LAST_VISIT'
h4='SCORE_SUM'
h5='SCORE_AVG'
date.=''
...
Return strip(swl)
/* -------------------------------------------------------------------------
 * REXX C:\Users\PeterJ\rexxetta\rexx\Merge-and-aggregate-datasets\merge-and-aggregate-datasets.rexx was migrated on 23 Mar 2025 at 10:43:21
 * -------------------------------------------------------------------------
*/ 

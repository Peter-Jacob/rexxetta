...
/*ª*-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
/*ª*-- returns a comma separated string of mode values from a comma separated input vector string */
mode:
procedure
parse arg lvector
drop vector.
vector. = ''
call makeStem lvector /*ª*-- this call creates the "vector." stem from the input string */
seen.   = 0
modes.  = ''
modeMax = 0
do v_ = 1 to vector.0
...
/*ª*-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
/*ª*-- load the "vector." stem from the comma separated input vector string */
makeStem:
...
call show_mode 'E, n, z, y, k, l, o, p, Ã¤, d, i, e'                -- E n z y k l o p Ã¤ d i e
call show_mode 'E, n, z, y, k, l, o, p, Ã¤, d, i, e, Ã¤'             -- Ã¤
...
return
/* -------------------------------------------------------------------------
 * REXX C:\Users\PeterJ\rexxetta\rexx\Averages-Mode\averages-mode-2.rexx was migrated on 23 Mar 2025 at 10:43:06
 * -------------------------------------------------------------------------
*/ 

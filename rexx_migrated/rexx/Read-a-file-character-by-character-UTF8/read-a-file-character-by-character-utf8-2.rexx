...
*--------------------------------------------------------------------*/
oid='utf8.txt';'erase' oid /*ª* first create file containing utf8 chars*/
...
Call lineout oid
fid='utf8.txt'             /*ª* then read it and show the contents     */
Do Until c8='EOF'
c8=get_utf8char(fid)
...
/* -------------------------------------------------------------------------
 * REXX C:\Users\PeterJ\rexxetta\rexx\Read-a-file-character-by-character-UTF8\read-a-file-character-by-character-utf8-2.rexx was migrated on 23 Mar 2025 at 10:43:26
 * -------------------------------------------------------------------------
*/ 

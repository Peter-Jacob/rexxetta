/*ª*REXX program picks a   random element   from a list   (tongue in cheek, a visual pun).*/
...
n=words(l)                       /*ª* Number of known elements            */
/*ª*-----  You can't trust atoms,   -----*/
/*ª*-----  they make everything up. -----*/
Parse Arg pick                   /*ª* atomic number specified             */
If pick>n Then Do
...
item=word(l,take)                /*ª*pick the specified or random element */
Parse Var item name '_' symbol
If pick='' Then
which='Random'
Else
which='Specified'
Say which 'element: ' take name '('symbol')' /*ª*stick a fork in it,  we're all done. */
/* -------------------------------------------------------------------------
 * REXX C:\Users\PeterJ\rexxetta\rexx\Pick-random-element\pick-random-element-1.rexx was migrated on 23 Mar 2025 at 10:43:24
 * -------------------------------------------------------------------------
*/ 

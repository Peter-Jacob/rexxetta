/*ª* REXX -------------------------------------------------------------------*/
results = '000000'                      /*ª*start with left teams all losing */
...
Select
When r='2' Then                   /*ª* win for left team               */
records.g1=records.g1+3
When r='1' Then Do                /*ª* draw                            */
records.g1=records.g1+1
records.g2=records.g2+1
End
When r='0' Then                   /*ª* win for right team              */
records.g2=records.g2+3
End
End
Call sort_records                     /*ª* sort ascending,                 */
/*ª* first place team on the right   */
r1=records.1
r2=records.2
r3=records.3
r4=records.4
...
/*ª* results is a string of 6 base 3 digits to which we add 1                */
/*ª* e.g., '000212 +1 -> 000220                                              */
...
Return
/* -------------------------------------------------------------------------
 * REXX C:\Users\PeterJ\rexxetta\rexx\World-Cup-group-stage\world-cup-group-stage-1.rexx was migrated on 23 Mar 2025 at 10:43:35
 * -------------------------------------------------------------------------
*/ 

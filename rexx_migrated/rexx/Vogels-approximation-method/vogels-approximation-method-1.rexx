...
Do r=1 To rr
Do c=1 To cc
cost.r.c=word(matrix.r.c,3)   /*ª* restore cost.*.* */
End
End
...
Select
When source_sum=demand_sum Then Nop  /*ª* balanced */
When source_sum>demand_sum Then Do   /*ª* unbalanced - add dummy demand */
...
End
End
Otherwise /*ª* demand_sum>source_sum */ Do /*ª* unbalanced - add dummy source */
...
Exit 12
/* -------------------------------------------------------------------------
 * REXX C:\Users\PeterJ\rexxetta\rexx\Vogels-approximation-method\vogels-approximation-method-1.rexx was migrated on 23 Mar 2025 at 10:43:35
 * -------------------------------------------------------------------------
*/ 

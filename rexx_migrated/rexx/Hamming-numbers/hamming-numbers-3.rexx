...
newV4.n= format(m,,,,0)          /*�*now,  assign the next Hamming number.*/
...
do j=x  to y;      say 'Hamming('right(j, w)") ="     newV4.j / 1
end   /*�*j*/

say right( 'length of last Hamming number ='     length(newV4.y / 1), 70);        say
return
/* -------------------------------------------------------------------------
 * REXX C:\Users\PeterJ\rexxetta\rexx\Hamming-numbers\hamming-numbers-3.rexx was migrated on 23 Mar 2025 at 10:43:15
 * -------------------------------------------------------------------------
*/ 

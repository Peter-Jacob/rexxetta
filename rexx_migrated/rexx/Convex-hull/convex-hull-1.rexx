...
Parse Arg fid
If fid='' Then Do
fid='chullmin.in'                 /*ª* miscellaneous test data       */
fid='chullx.in'
fid='chullt.in'
fid='chulla.in'
fid='chullxx.in'
...
fid='line.in'
fid='point.in'
fid='chull.in'                    /*ª* data from task description    */
End
g.0debug=''
...
End
Call lineout fid
Do i=1 To x.0                       /*ª* loop over points              */
x=x.i
yl.x=sortv(yl.x)                  /*ª* sort y-coordinates            */
End
Call sho
...
nhull=nhull n_end                /*ª* attach the right vertical border */
...
chull=nhull shull                 /*ª* concatenate upper and lower part */
/*ª* eliminate duplicates             */
/*ª* too lazy to take care before :-) */
...
Exit 12
/* -------------------------------------------------------------------------
 * REXX C:\Users\PeterJ\rexxetta\rexx\Convex-hull\convex-hull-1.rexx was migrated on 23 Mar 2025 at 10:43:09
 * -------------------------------------------------------------------------
*/ 

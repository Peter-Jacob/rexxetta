...
If left(system,3)='WIN' |,  /*ª* changed from 'Windows' (I see WIN64 in source) */
...
Return
/* -------------------------------------------------------------------------
 * REXX C:\Users\PeterJ\rexxetta\rexx\Text-processing-Max-licenses-in-use\text-processing-max-licenses-in-use-2.rexx was migrated on 23 Mar 2025 at 10:43:33
 * -------------------------------------------------------------------------
*/ 

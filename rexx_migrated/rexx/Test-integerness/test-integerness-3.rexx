...
if newV1=''  then newV1= '3.14   1.00000   33   999999999   99999999999   1e272   AA   0'    ,
...
/*�*──────────────────────────────────────────────────────────────────────────────────────*/
isSign: parse arg newV2 2;   return newV2=='+' | newV2=="-"  /*�*a method to test for a leading sign. */
/*�*──────────────────────────────────────────────────────────────────────────────────────*/
...
newV3=  left(p, 1)                           /*�*obtain the possible sign of the power*/
if isSign(newV3)  then p=substr(p, 2)        /*�*strip the sign from the exponent.    */
...
/* -------------------------------------------------------------------------
 * REXX C:\Users\PeterJ\rexxetta\rexx\Test-integerness\test-integerness-3.rexx was migrated on 23 Mar 2025 at 10:43:33
 * -------------------------------------------------------------------------
*/ 

...
say copies(_,30) copies(_,32) copies(_,39) copies(_,5) copies(_,5) /*ª*hdr*/
...
Return o2 'IPv6' port
/* -------------------------------------------------------------------------
 * REXX C:\Users\PeterJ\rexxetta\rexx\Parse-an-IP-Address\parse-an-ip-address-2.rexx was migrated on 23 Mar 2025 at 10:43:23
 * -------------------------------------------------------------------------
*/ 
